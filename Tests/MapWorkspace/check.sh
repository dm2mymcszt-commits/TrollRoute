...
xcrun --sdk iphonesimulator swiftc TrollRoute/Storage/SharedPreferences.swift TrollRoute/Storage/FavoritesStore.swift -target arm64-apple-ios17.0-simulator \
  ...
  TrollRoute/LocSim/RouteLocationPicker.swift TrollRoute/LocSim/FavoritePlaceEditor.swift TrollRoute/LocSim/PlaceModels.swift TrollRoute/LocSim/PlaceInput.swift TrollRoute/LocSim/AddressQuery.swift TrollRoute/LocSim/PlaceSearch.swift TrollRoute/LiveActivity/RouteActivityAttributes.swift TrollRoute/LiveActivity/RouteActivityController.swift TrollRoute/LiveActivity/RouteActivityState.swift TrollRoute/SettingsView.swift TrollRoute/LocationAccess.swift \
