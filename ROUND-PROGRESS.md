...
- Live Activity architecture audit `84c3833`; build46 adds actual-journey content and trip-scoped command tests. Runtime/widget not yet connected.
- **Next:** verify build46 CI, connect one shared app route runtime to ActivityKit/intents, then widget/settings and system UI/compatibility checks. Delete all three ROUND files in the final commit.
